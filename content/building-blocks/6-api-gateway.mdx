...
- What?
  ...
  - Abstraction layer, remove deps of client on microservices (otherwise, clients call services directly)
  - where security are enforced so that can be loosen internally
